...
# Lines we used to check our program was working
...
def get_sales_data():
    ...
    while True:
        ...
        # Print method was just to check input working
...
def validate_data(values):
    """
    Within our try, run code if data valid
    Except statement will print error to terminal if not
    """
    try:
...
def update_worksheet(data, worksheet):
    """
    Receives data to be inserted to worksheet
    """
...
def get_last_5_entries_sales():
    ...
    last 5 entries for each sandwich
    """
    sales = SHEET.worksheet("sales")
    columns = []
